...
const ProductDetials = ({product,setItems}) => {
    const {
        price,
        productName,
        img,
    ...
    return (
        ...
        <div className="card-body">
          ...
          onClick={()=>setItems(product)}
           htmlFor="Product-modal" disabled={availableQuantity === 0} className="btn border-0  bg-gradient-to-r from-primary to-accent w-full text-white font-bold">Buy Now</label>
